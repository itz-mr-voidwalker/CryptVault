...
class EmailVerification:
    ...
    def send_thread(self, subject, code:int, to_email:str) -> bool:
        """
    ...
    def send_email(self, subject, code:int, to_email:str):
        thread = threading.Thread(target=self.send_thread, args=(subject,code,to_email,))
        thread.start()
